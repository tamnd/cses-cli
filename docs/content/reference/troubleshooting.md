...
Most of these come down to network reality or how cses serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cses rate-limits like any public site. cses already paces
...
Where a surface is gated, cses reads a cookie or token you supply
...
`cses`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cses actually did
